...
%% and within that folder, another folder to hold the descriptors we are interested in working with
DESCRIPTOR_SUBFOLDER='edgeOrientHist';
...
for img_idx=1:10
    ...
    for i=1:NIMG
        ...
        %% Distance measure:
        thedst=cvpr_compare(query,candidate, 3);
...
ylabel('mean average precision per class')
