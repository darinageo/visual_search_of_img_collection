...
OUT_FOLDER = '/Users/darinageorgieva/Documents/dev/uni/cvprlab/labs/cw/cwork_basecode_2012/descriptors';
%% and within that folder, create another folder to hold these descriptors
%% the idea is all your descriptors are in individual folders - within
%% the folder specified as 'OUT_FOLDER'.
OUT_SUBFOLDER='combined';
...
for filenum=1:length(allfiles)
    ...
    %% Image descriptors:
    % Input parameters: (img, rows, cols, level of quantization)
    F=spatial_grid_combined(img, 16, 16, 8);
